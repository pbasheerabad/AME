...
public class stagingInput extends javax.swing.JFrame 
{
	public static String str1, input;
	int stt1;
    ...
    private void initComponents() 
    {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Input Data", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Times New Roman", 0, 14), new java.awt.Color(0, 0, 0))); 
        ...
        jLabel1.setText("Input Table Data");
        jPanel1.add(jLabel1);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) 
    {
        try
        {
            ...
            DatabaseMetaData meta = con.getMetaData(); 
   			ResultSet res = meta.getTables(null, null, "input", null); 
   			if(!res.next())
   			{ 
   				String sql1 = "CREATE TABLE input " + 
   						"(`id` int(100),`Title` varchar(2000),`Doc_Id` varchar(50))";
   				stmt.executeUpdate(sql1);		
   			} 
   			else
   			{
   				stmt.executeUpdate("TRUNCATE TABLE `input`"); 			    
   			}
               ...
               int a = 0;
               String str = null;
               File folder = new File("C:/Users/Public/Documents/Input");
               int count=0;
               ...
               for (int i = 0; i < listOfFiles.length; i++) 
               {
                    if (listOfFiles[i].isFile()) 
                    {
                        ...
                        if(files.contains(".txt"))
                        {
                            ...
                            doc[i]=files;
                            BufferedReader br=new BufferedReader(new FileReader(new File("C:/Users/Public/Documents/Input/"+files)));
                            ...
                            {   
                                ...
                                stmt1.executeUpdate("INSERT INTO `AME`.`input` (`id`, `Title`, `Doc_Id`) VALUES ('"+a+"', '"+str1+"', '"+(i+1)+"')");
               ...
               JOptionPane.showMessageDialog(this,"Input data is loaded into Input table");
        }
