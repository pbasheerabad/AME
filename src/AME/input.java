...
public class input extends javax.swing.JFrame 
{
    ...
    private void initComponents() 
    {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Input Data", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Calibri", 0, 14), new java.awt.Color(51, 51, 51))); 
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Input Files", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Calibri", 0, 14), new java.awt.Color(0, 0, 0))); // NOI18N
            ...
            for (int i = 0; i < listOfFiles.length; i++) 
            {
                if (listOfFiles[i].isFile()) 
                {
                    ...
                    if(files.contains(".txt"))
                    {
                        doc[i]=files;
                        jTextArea1.append("\n\n"+files+"\t\t"+size);
                        System.out.println("C:/Users/Public/Documents/Input/"+files);
                        hm.put(files, k);
                        k++;
                    }
                 }
