		...
		public void endElement(String namespaceURI, String localName, String rawName) throws SAXException 
		{
			...
			if (Element.getElement(rawName) == Element.INPROCEEDING) 
			{
				...
				try 
				{
					...
					String str1 = paper.title;
					try (Writer writer = new BufferedWriter(new OutputStreamWriter(
				              new FileOutputStream("Papers.txt",true), "utf-8"))) {
						writer.write(str1);
						writer.write("\n");
			...
			else if (Element.getElement(rawName) == Element.PROCEEDING) 
			{
				...
				try 
				{
					...
					stmt_conf.addBatch();
					String str = conf.name;
					//System.out.println("Name::" + str);
					/*try  
					{
					    FileWriter fstream = new FileWriter("E:\\output.txt", true); //true tells to append data.
					    out = new BufferedWriter(fstream);
					    out.write(str);
					    out.write("\n");
					}*/
					try (Writer writer = new BufferedWriter(new OutputStreamWriter(
				              new FileOutputStream("Conference.txt",true), "utf-8"))) {
						writer.write(str);
						writer.write("\n");
						//System.out.println("Name::" + str);
					}	
